package kz.abcsoft.androidshop;
...
public class EditProductActivity extends Activity {
    ...
    private static final String url_product_details = "http://192.168.56.1/test/get_product_details.php";

    // адрес для обновления базы данных
    private static final String url_update_product = "http://192.168.56.1/test/update_product.php";

    // адрес для удаления из базы данных
    private static final String url_delete_product = "http://192.168.56.1/test/delete_product.php";
